...
void Model::initNode(aiNode *node, const aiScene *scene) {
...
std::vector<Texture> Model::loadTexturesForMesh(aiMaterial *material, aiTextureType type, std::string typeName) {
	std::vector<Texture> textures;
